...
Read `docs/MEMORY.md` now. It is ~50 lines. It tells you everything about where the project is.
...
| File | Load when |
|---|---|
| `docs/PROJECT.md` | Building a new feature, unclear on spec, checking data contracts |
| `docs/TASKS.md` | Asked "what's next", starting a new phase, checking what's done |
...
**End session:**
```
Update docs/MEMORY.md: move done items, update In Progress, set Next 3, add any new decisions, note blockers, update Phase and date.

Also Update docs/TASKS.md: change status of the tasks according the present status.
```